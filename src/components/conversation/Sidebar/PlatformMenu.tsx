        ...
        items={[
          {
            ...
            label: <Link href={"/conversation/platform/1"}>Zalo</Link>,
          ...
          },
          {
            ...
            label: <Link href={"/conversation/platform/2"}>Telegram</Link>,
            className: style.selectAnt,
          },
          {
            key: "messenger",
            ...
            label: <Link href={"/conversation/platform/3"}>Messenger</Link>,
            className: style.selectAnt,
          },
          {
            key: "website",
            icon: <GlobalOutlined />,
            label: <Link href={"/conversation/platform/4"}>Website</Link>,
            className: style.selectAnt,
          },
        ]}
      />
